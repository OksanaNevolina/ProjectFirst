// в цьому завданні(а саме, там де всю інфу про користувача потрібно вивести) робила 3-ма способами.
//     Руцями все виводить, циклами і рекурсією, залишила рекурсію, там де найменше коду,
//     але працює вона в мене не дуже коректно...
